        ...
        <div tabIndex={0} className="dropdown-content">
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M118.02 146.54C134.379 146.54 147.64 133.279 147.64 116.92C147.64 100.561 134.379 87.3 118.02 87.3C101.661 87.3 88.4 100.561 88.4 116.92C88.4 133.279 101.661 146.54 118.02 146.54Z"
                stroke="hsl(var(--a))"
                strokeWidth="12"
                strokeMiterlimit="10"
                strokeLinecap="round"
              ...
              />
              <path
                d="M197.02 312.7C213.379 312.7 226.64 299.439 226.64 283.08C226.64 266.721 213.379 253.46 197.02 253.46C180.661 253.46 167.4 266.721 167.4 283.08C167.4 299.439 180.661 312.7 197.02 312.7Z"
                stroke="hsl(var(--a))"
                strokeWidth="12"
                strokeMiterlimit="10"
                strokeLinecap="round"
              ...
              />
              <path
                d="M263.09 229.62C279.449 229.62 292.71 216.359 292.71 200C292.71 183.641 279.449 170.38 263.09 170.38C246.731 170.38 233.47 183.641 233.47 200C233.47 216.359 246.731 229.62 263.09 229.62Z"
                stroke="hsl(var(--a))"
                strokeWidth="12"
                strokeMiterlimit="10"
                strokeLinecap="round"
